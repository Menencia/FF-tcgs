module.exports = function() {
  ...
  (function(Z) {
    ...
    function Q(b, c, e, h) {
      c && F(c, function(c, j) {
        if (e || !t(b, j))
          h && "string" !== typeof c ? (b[j] || (b[j] = {}), Q(b[j], c, e, h)) : b[j] = c;
      });
      return b;
    }
    function u(b, c) {
    ...
    if ("undefined" === typeof define) {
      ...
      z && !s.skipDataMain && M(document.getElementsByTagName("script"), function(b) {
        ...
        if (J = b.getAttribute("data-main"))
          return q = J, s.baseUrl || (D = q.split("/"), q = D.pop(), fa = D.length ? D.join("/") + "/" : "./", s.baseUrl = fa), q = q.replace(ea, ""), j.jsExtRegExp.test(q) && (q = J), s.deps = s.deps ? s.deps.concat(q) : [q], !0;
      });
